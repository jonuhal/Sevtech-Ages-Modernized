...
# SevTech: Ages Modernized - Local Deployment Script for WSL to Windows CurseForge
...
CF_DIR="/mnt/c/Users/jonuh/curseforge/minecraft/Instances/Sevtech Ages - Modernized"
...
echo -e "${BLUE}=== Starting SevTech: Ages Modernized Windows/WSL Deployment ===${NC}"
...
echo -e "${BLUE}Clearing out logs and crash reports...${NC}"
rm -rf "$CF_DIR/logs"
